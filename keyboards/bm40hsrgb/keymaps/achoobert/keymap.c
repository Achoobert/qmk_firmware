 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Esc  |   A  |   R  |   S  |   T  |   G  |M/read|   N  |   E  |   I  |O/ Nav|  "   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_NAV] = LAYOUT_planck_mit(
    _______, KC_GRV,  KC_SLSH, KC_BSLS, KC_AMPR, _______, KC_PSCR, PSCREEN_APP,  KC_UP,   _______, _______, KC_DEL ,
    _______, KC_PLUS, KC_LCBR, KC_CBRL, KC_LPRN, _______, _______, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______,
